...
# --- CHANGE THESE VALUES HERE ONLY ---
    ...
    if direction is None:
        logging.info(f"No trade signal based on current logic...")
        # return
...
try:
    ...
    while True:
        ...
        # The 'elif is_market_open():' and 'else:' blocks are commented out for this test.
        # This forces the bot to check for trades even when the market is closed.
